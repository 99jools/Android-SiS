...
//	    System.out.println(javax.xml.bind.DatatypeConverter.printHexBinary(encryptionCipher.getIV()))	;    	    
		return newKey;
	} //end EncryptFile
	...
	public static  void decryptFile(FileInputStream ciphertextAsFileIn, FileOutputStream  plaintextAsFileOut, KeyManagement decryptKey ) 
		...
		System.out.println("iv recovered from file" +(javax.xml.bind.DatatypeConverter.printHexBinary(initVector)))	;    
		System.out.println("testIV" +(javax.xml.bind.DatatypeConverter.printHexBinary(initVector)))	;    
...
//  	System.out.println("dummy IV" +(javax.xml.bind.DatatypeConverter.printHexBinary(dummyIV)))	;    		

		return new IvParameterSpec(dummyIV);
		

//	System.out.println("encrypt key" +(javax.xml.bind.DatatypeConverter.printHexBinary(decryptKey.getMyKeySpec().getEncoded())))	;    
	}
